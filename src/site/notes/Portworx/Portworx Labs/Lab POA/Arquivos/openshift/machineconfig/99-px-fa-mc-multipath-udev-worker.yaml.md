---
{"dg-publish":true,"permalink":"/Portworx/Portworx Labs/Lab POA/Arquivos/openshift/machineconfig/99-px-fa-mc-multipath-udev-worker.yaml/","dg-note-properties":{}}
---
...
metadata:
  ...
  name: 99-portworx-multipath-udev-mc-worker
spec:
  config:
    ignition:
      version: 3.2.0
